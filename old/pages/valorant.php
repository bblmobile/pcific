...
<title> Valorant Takımımız - PCIFIC ESPOR</title>
            ...
            <div class="container">
				<div class="row " style="margin-bottom:40px">
					<div class="text-center">
						<img src="/valorant/logo.png" style="width:150px; margin-bottom:30px">
						<h3>BBL PCIFIC</h3>
						</div>
					</div>
                <div class="row flex-nowrap">
					<div class="team">
					  <div class="player">
						<img src="/valorant/p-1.png" alt="Player 1" class="dark">
						   <div class="info">
							  <h4>Loita</h4>
							  <p>Utku Kart</p>
						  </div>
					  ...
					  <div class="player">
						<img src="/valorant/p-2.png" alt="Player 2" class="dark">
						   <div class="info">
							  <h4>Crewen</h4>
							  <p>Ali Eren Sargın</p>
						  </div>
						...
						<div class="player">
						<img src="/valorant/p-3.png" alt="Player 2" class="dark">
							<div class="info">
							  <h4>Rosé</h4>
							  <p>Eren Erzan</p>
						  </div>
						...
						<div class="player">
						<img src="/valorant/p-4.png" alt="Player 2" class="dark">
								<div class="info">
							  <h4>ComeBack</h4>
							  <p>Berkcan Şentürk</p>
						  </div>
						...
						<div class="player">
						<img src="/valorant/p-5.png" alt="Player 2" class="dark">
							<div class="info">
							  <h4>Lar0k</h4>
