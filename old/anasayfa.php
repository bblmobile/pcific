...
<body>
	...
	<main>
		...
		<section class="section-hero-2 position-relative pt-160 overflow-hidden">
			...
			<div class="d-flex container-fluid flex-column flex-lg-row align-items-lg-end align-items-center justify-content-center gap-5 pb-160">


				<div class="card-hero-2 zoom-img px-2 px-md-0 position-relative">
					<div class="rounded-3 overflow-hidden">
						<img class="w-100 wow img-custom-anim-left" src="assets/gorseller/takim_3.jpg" alt="Pcific - CS 2 Takımı">
					</div>
				...
				<div class="card-hero-2 zoom-img px-2 px-md-0 position-relative">
					<div class="rounded-3 overflow-hidden">
						<img class="w-100 wow img-custom-anim-left" src="assets/gorseller/takim_2.jpg" alt="BBL Pcific - Valorant Takımı">
					</div>
					<div class="background-brand position-absolute bottom-0 start-0 z-0 w-100"></div>
					<div class="brand opacity-0 position-absolute bottom-0 start-0 p-5 w-100">
						<p class="mb-2 mt-1 d-none d-md-block mb-4 ">
				...
				<div class="card-hero-2 zoom-img px-2 px-md-0 position-relative">
					<div class="rounded-3 overflow-hidden">
						<img class="w-100 wow img-custom-anim-left" src="assets/gorseller/takim_1.jpg" alt="Pcific - FC 25 Takımı">
					</div>
					<div class="background-brand position-absolute bottom-0 start-0 z-0 w-100"></div>
					<div class="brand opacity-0 position-absolute bottom-0 start-0 p-5 w-100">
						<p class="mb-2 mt-1 d-none d-md-block mb-4 ">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 position-relative pe-lg-10">
						...
						<p class="mt-4">Espor izleyerek büyüyen insanların, bu alanda emek vermek isteyen gençlere destek olmak, alan tanımak ve yerel kültürle bütünleşik, herkesin ait hissedebildiği bir kulüp kurma fikri ile yola çıkan PCIFIC Esports, 2018 yılında kuruldu.</p>
						...
						<div class="row justify-content-start mt-5">
							<div class="position-relative border border-primary border-opacity-25 icon_160 icon-shape rounded-circle shadow">
								<img class="position-relative" src="assets/imgs/testimonials/testimonials-2/badge-icon.svg" alt="muzilla">
					...
					<div class="col-lg-6 mt-lg-0 mt-5">
						<div class="position-relative d-inline-flex">
							<img class="rounded-4" src="assets/gorseller/takim2.jpg" alt="muzilla">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container-fluid pt-10 pb-10">
				...
				<div class="swiper-container">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<a href="#" class="brand d-flex align-items-center opacity-50">
								<img src="https://pcific.shop/upload/1725635872-66db1d2044b18.png" alt="Webisse Web Solutions">
							</a>
						</div>
		...
		<!-- News-2 -->
		<section class="section-news-2 pt-120 pb-120 bg-black-2">
			<div class="container tg-heading-subheading animation-style3">
				<div class="d-flex align-items-center mb-3">
					<span class="text-uppercase fw-bold text-primary fs-7 text-nowrap">PCIFIC ESPORTS</span>
					<span class="line ms-4"></span>
				</div>
				<h2 class="text-end pb-80 Company updates">Blog Yazılarımız</h2>
			</div>
			<div class="container">
				<div class="row gy-40">
					<div class="col-lg-7">
						<ul class="news2-tab-wrap list-unstyled pe-lg-10" id="tabs-nav">
							<li class="news2-tab">
								<div class="news2-tab-item border-white border-bottom border-opacity-10 pb-5" data-bs-toggle="tab" data-bs-target="#tab1">
									<div class="d-flex align-items-center">
										<strong>Kategori</strong>
										<div class="line-soft mx-4"></div>
										<i class="bi bi-calendar-minus-fill text-white"></i>
										<p class="mb-0 text-uppercase ms-2 fs-7 fw-regular">01 Ocak 2024</p>
									</div>
									<a href="#">
										<h2 class="fs-2 mt-3">Blog Başlığı</h2>
									</a>
								</div>
							</li>
							<li class="news2-tab">
					...
					<div class="col-lg-5 wow img-custom-anim-left">
						<div id="tabs-content">
							<div id="tab1" class="news2-tab-content">
								<div class="service-thumb rounded-4overflow-hidden">
									<img class="w-100" src="assets/imgs/news/news-2/img-1.png" alt="img">
								</div>
							</div>
							<div id="tab2" class="news2-tab-content">
								<div class="service-thumb rounded-4overflow-hidden">
									<img class="w-100" src="assets/imgs/news/news-1/img-2.png" alt="img">
								</div>
							</div>
							<div id="tab3" class="news2-tab-content">
								<div class="service-thumb rounded-4overflow-hidden">
									<img class="w-100" src="assets/imgs/news/news-1/img-3.png" alt="img">
								</div>
							</div>
						</div>
					</div>
